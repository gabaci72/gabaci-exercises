...
// let initialMemory = null;// Change this line so that initialMemory is assigned the value of the heapUsed property on the object returned from invoking the process.memoryUsage() method.
let initialMemory = process.memoryUsage().heapUsed;
let word = process.argv[2]; //node app.js Codecademy would result in word being assigned the value 'Codecademy'
